...
with st.sidebar:
    ...
    with st.sidebar:
        ...
        with st.expander('Need instructions?', expanded=True):
...
def dashboard(df, stacked_df, df2):
    ...
    if dashtype == 'Explore':
        ...
        tab1, tab2 = st.tabs(["**Click Here To Explore How Funding Flows**",
                                        "**Click Here to Explore Word Usage and Research Topics**"])
